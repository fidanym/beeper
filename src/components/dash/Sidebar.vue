    ...
    <div id="sidebar" class="text-center">
        <div v-if="loggedIn">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <router-link :to="'/newsfeed'" class="btn btn-block btn-light">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <p class="text-center no-margin">
                        <a @click.prevent="logout" href="#"><i class="fa fa-power-off"></i> Logout</a>
                    </p>
                </div>
            </div>
        </div>
        <div v-if="!loggedIn">
            ...
            <p class="text-center">
                ...
                <br>
                <router-link to="/auth/login" class="btn btn-light btn-block">Login</router-link>
            </p>
        </div>
    </div>
</template>
